        ...
        <div class="bg-white w-1/3 rounded-lg shadow-lg p-6">
          ...
          <form @submit.prevent="submitForm">
            <div class="mt-4">
              ...
              <textarea v-model="formData.message" class="w-full border border-gray-300 rounded-lg p-2 mt-1" rows="3"></textarea>
            </div>
            <div class="mt-4">
              <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700">Submit</button>
              <button @click="closeModal" class="bg-gray-500 text-white px-4 py-2 ml-2 rounded hover:bg-gray-700">Close</button>
            </div>
          </form>
        </div>
      </div>
